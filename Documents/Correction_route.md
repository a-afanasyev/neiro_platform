...
**Версия:** 2.3
**Дата:** 22 ноября 2025
**Статус:** синхронизировано с `DATA_MODEL_AND_EVENTS.md` v0.5 и SoT v3.5, включая обновленную схему данных, именование таблиц (множественное число), Constitution Check правила и расширенные доменные события с correlation_id/causation_id.
