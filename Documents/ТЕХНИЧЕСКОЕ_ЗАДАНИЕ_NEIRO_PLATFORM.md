...
> **📖 Полная спецификация:** `API_CONTRACTS_MVP.md` (версия 0.7)
...
- API документация (см. `API_CONTRACTS_MVP.md` v0.7)
- Комментарии в коде
- Архитектурная документация
- **✅ Модель данных:** `DATA_MODEL_AND_EVENTS.md` v0.4
...
|----------|--------|--------|----------|
| `DATA_MODEL_AND_EVENTS.md` | 0.4 | ✅ Готов | 27 таблиц с SQL DDL, 10 бизнес-правил, 36 событий, transport via Outbox |
| `API_CONTRACTS_MVP.md` | 0.8 | ✅ Готов | 12 сервисов, Webhook API, tRPC namespace, интеграции Telegram/WebRTC/Gamification |
