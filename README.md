...
- **Событийность:** доменные события по конвенциям `DATA_MODEL_AND_EVENTS.md`, публикация через Postgres Outbox + фоновые воркеры (DLQ `event_outbox_failures`, см. `constitution.md` §7)  
...
| Конституция проекта | Принципы, стек, сервисные границы, Gate'ы (v1.1) | `constitution.md` |
...
- Конституционные Gate'ы (Stack, Service Boundaries, Data Policy и др.) обязательны для всех фич; актуальная версия — `constitution.md` v1.1.
